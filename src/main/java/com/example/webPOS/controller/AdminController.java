...
//</form>
    ...
    public String showAdminPage(
        ...
        } else if (action.equals(UrlParamAction.DELETE_MEMBER)) {
        ...
        } else if (action.equals(UrlParamAction.PROCESS_ENROLL_PRODUCT)) {
            return productEnrollment(request, model);//내부 메소드매핑
    ...
    public String productEnrollment(HttpServletRequest request, Model model) {
